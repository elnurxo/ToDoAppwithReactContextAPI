      ...
      >
        <Toolbar>
          ...
          <Box sx={{ display: { xs: "none", sm: "block" } }}>
            ...
            <Link to="todos">
              <Button className="link" sx={{ color: "#fff" }}>View ToDos</Button>
            </Link>
            <Link to="addtodo">
              <Button className="link" sx={{ color: "#fff" }}>Add To Do</Button>
            </Link>
            <Link to="completedtodos">
              <Button className="link" sx={{ color: "#fff" }}>Completed ToDos</Button>
            </Link>
          </Box>
        </Toolbar>
      </AppBar>
